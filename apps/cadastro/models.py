"""
Models para o app Cadastro
IMPORTANTE: ApÃ³s configurar o projeto, execute:
docker-compose exec backend python manage.py inspectdb > apps/cadastro/models_generated.py

Depois, copie os models relevantes deste arquivo gerado para cÃ¡ e ajuste conforme necessÃ¡rio.
"""
from django.db import models

class BaseModel(models.Model):
    """Model base com campos comuns"""
    criado_em = models.DateTimeField(auto_now_add=True, db_column='created_at')
    atualizado_em = models.DateTimeField(auto_now=True, db_column='updated_at')
